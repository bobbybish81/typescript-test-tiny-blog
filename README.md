...
# Task
 To create a blog that connects to this api https://dummyjson.com/posts. The blog only shows different post but the important thing is to have sections for the different posts.
